...
public class TabViewModelFactory extends ViewModelProvider.NewInstanceFactory {
    ...
    private DeleteWorkoutByIdUseCase deleteWorkoutByIdUseCase;
    public TabViewModelFactory (Context context){
        ...
        deleteWorkoutByIdUseCase = new DeleteWorkoutByIdUseCase(workoutRepository);
    }
    @NonNull
    @Override
    public <T extends ViewModel> T create (@NonNull Class<T> modelClass){
        return (T) new TabViewModel(saveWorkoutUseCase,getWorkoutListUseCase,deleteWorkoutByIdUseCase);
    }
